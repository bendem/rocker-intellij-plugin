...
public abstract class RockerElementRef extends PsiReferenceBase<IdentifierPSINode> {
	public RockerElementRef(@NotNull IdentifierPSINode element) {
		/** WARNING: You must send up the text range or you get this error:
		 * "Cannot find manipulator for PsiElement(ID) in be.bendem.rockerintellij.RockerElementRef"...
