 ...
 */
public class RockerExternalAnnotator extends ExternalAnnotator<PsiFile, List<RockerExternalAnnotator.Issue>> {
	...
	public List<Issue> doAnnotate(final PsiFile file) {
		...
		// 	XPath.findAll(RockerLanguage.INSTANCE, file, "/script/function/ID");
		// Collection<? extends PsiElement> funcCallNameNodes =
		// 	XPath.findAll(RockerLanguage.INSTANCE, file, "//call_expr/ID");
		//
